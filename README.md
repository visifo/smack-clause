...
```php
use Visifo\SmackClause\Exception\SmackException;use Visifo\SmackClause\Exception\Trace;use Visifo\SmackClause\Extension\CustomSmack;use Visifo\SmackClause\Extension\SmackMethod;
